...
<div id="pageMain" class="page_srcoll page-current">
  ...
  <!--<div class="tabs">
   <ul>
				...
				<div class="gentie post_item">
					<div class="user_info">
						...
						<ul>
							...
							<div class="reply_btn" onclick="return loadRevertReplay(this,'487','spirit','1');"></div>
					</div>
					<div class="con">
						<div class="comment_reply">
							<div class="comment_user clearfix"><a href="#" onclick="return loadRevertReplay(this,'84','energy','1');" class="replay_btn replay_life">回复</a><span class="comment_floor right">1</span><span class="userName">energy</span><span class="dtappenddate">07-16 16:27</span></div>
	...
	<form action="" id="myform" method="post" target="tijiao">
	<div class="inner">
		...
		<input type="submit" class="rsubmit" value="发表" />
	</div>
	</form>
</div>
	<div class="footFixed">
