	...
	$(function(){
		...
		$("#fabiao").click(function(data){
			var data={};
			    ...
			    data.fid=$("#fid").val();
			console.log(data);
			$.post("/wap/forum/fatie",data,function(){
