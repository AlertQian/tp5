<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"D:\wamp\www\tp5\public/../application/wap\view\user\editcon.html";i:1546780403;s:55:"D:\wamp\www\tp5\application\wap\view\public\header.html";i:1545395791;s:55:"D:\wamp\www\tp5\application\wap\view\public\footer.html";i:1545472561;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
   ...
   <div class="tabItem tab-cont" style="display:block;">
    <div class="inp_Itembox">
        <dl class="clearfix" style="padding-left:0;">
          <dd style="padding-left:0;"><input type="text" name="title" id="fabu_title" value="<?php echo $ret['title']; ?>" placeholder="标题(必填)"></dd>
        </dl>
        <dl class="clearfix" style="padding-left:0;">
      ...
      <div class="reply_tabs" id="reply_tabs">
        ...
        <div class="tab-cont">
          <div class="imgcon">
            ...
            <input type="hidden" name="imgs" class="layui-input" value="<?php echo $ret['pic']; ?>">
