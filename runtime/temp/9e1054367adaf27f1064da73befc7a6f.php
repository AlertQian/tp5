<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"D:\wamp\www\tp5\public/../application/wap\view\forum\add.html";i:1546593789;s:55:"D:\wamp\www\tp5\application\wap\view\public\header.html";i:1545358047;s:55:"D:\wamp\www\tp5\application\wap\view\public\footer.html";i:1545529423;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
      ...
      <div class="reply_tabs" id="reply_tabs">
        ...
        <div class="tab-cont" style="display:none;">
          <div class="face" id="emot_inner">
            <div class="clearfix">
              <ul class="clearfix ul_0">
                <li>
                  <a href="#" class="itemEmot" onclick="return insertAtCaret(this,'cmt_txt','/wap/main/arclist/1.gif');" data-src="/wap/arclist/1.gif" data-alt="拥抱">
                  <img src="/wap/main/arclist/1.gif" alt=""></a>
                </li>
                <li>
                  <a href="#" class="itemEmot" onclick="return insertAtCaret(this,'cmt_txt','/template/wap/main/arclist/2.gif');" data-src="/wap/main/arclist/2.gif" data-alt="撇嘴">
                  <img src="/wap/main/arclist/2.gif" alt=""></a>
                </li>
              </ul>
            </div>
          </div>
