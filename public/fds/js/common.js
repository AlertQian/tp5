...
function getLoginUserInfo(siteUrl,tplPath,hasQQ,hasWX,source){
	...
	if(LoginUserInfo_userid !== ''){
		...
		txt="<p class=\"login_success\"><span class=\"username\">"+LoginUserInfo_chrname+"</span>，您好！ <a href=\""+siteUrl+"member/index.html\">管理</a> <a href=\"javascript:loginout('"+siteUrl+"');\">退出</a></p><dl class=\"xian\"></dl>";
